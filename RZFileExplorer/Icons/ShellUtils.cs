...
namespace RZFileExplorer.Icons {
    public static class IconService {
        ...
        public static Icon GetFileIcon(string path, bool smallIcon, bool isDirectoryOrDrive) {
            ...
            return success == 0 ? null : Icon.FromHandle(shfi.hIcon);
        }

        public static BitmapSource GetFileIconAsBitmapSource(string path, bool smallIcon = true, bool isDirectory = false) {
            Icon icon = GetFileIcon(path, smallIcon, isDirectory);
